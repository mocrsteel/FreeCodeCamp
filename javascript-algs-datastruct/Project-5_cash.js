function checkCashRegister(price, cash, cid) {
    ...
    let sortedCID = cid.concat().sort((a, b) => moneyNames[b[0]] - moneyNames[a[0]]);
    ...
    if (totalFunds === changeRequired){
        ...
        return returnedCash.reduce((sum, subArr) => sum += subArr[1], 0) < changeRequired
                    ? {status: "INSUFFICIENT_FUNDS", change: []}
                    : {status: "OPEN", change: returnedCash} 
...
console.log(checkCashRegister(
    19.5, 20, [["PENNY", 0.01], ["NICKEL", 0], ["DIME", 0], ["QUARTER", 0],
